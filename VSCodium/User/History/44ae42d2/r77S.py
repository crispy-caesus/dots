...
class Menu():
    ...
    def drawButton(self, __buttonImagePath :str, __buttonOffsetX :int, __buttonOffsetY :int):
        ...
        leftBorder = screenResolution.x // 2 - buttonRect.width // 2 - buttonOffsetY
        topBorder = screenResolution.y // 2 - buttonRect.height // 2 - buttonOffsetX
        ...
        screen.blit(button, (leftBorder, topBorder))
